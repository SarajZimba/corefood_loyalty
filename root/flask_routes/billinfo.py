...
def billinfo():
    try:
        ...
        BillNo = json["bill_no"]
        Date = json["Date"]
        billdetailsSql =f"""SELECT bill_no, employee, Table_No,Start_Time,End_Time,Type,Date,serviceCharge,vat,total,PaymentMode, NoOfGuests FROM `tblorderhistory` WHERE Outlet_Name=%s and bill_no=%s and Date =%s"""
