...
# @app_file46.route("/getstocksbygroup", methods=["GET"])
# @cross_origin()
...
#             grouped_stocks[group_name].append(stock)

#         # Transform the grouped data into the desired format
#         formatted_data = [
#             {"group": group_name, "stocks": stocks} for group_name, stocks in grouped_stocks.items()
#         ]
