...
# def get_yearly_prediction(outlet_name, posted_date):
...
#     current_year = posted_date.year

#     # Generate a date range for the current year only (Jan 1st - Dec 31st)
#     prediction_dates = pd.date_range(start=f"{current_year}-01-01",
#                                      end=f"{current_year}-12-31",
#                                      freq='D')  # Daily frequency for the entire year
...
#     # Get the total prediction for the current year (sum of all daily predictions)
...
#     # Generate a date range for the current year (Jan 1st - Dec 31st)
#     prediction_dates = pd.date_range(start=f"{current_year}-01-01",
#                                      end=f"{current_year}-12-31",
#                                      freq='MS')  # Monthly frequency for the entire year

#     # Create a DataFrame with these dates
#     future = pd.DataFrame({'ds': prediction_dates})

#     # Make predictions for the date range (monthly predictions)
#     forecast = model.predict(future)
